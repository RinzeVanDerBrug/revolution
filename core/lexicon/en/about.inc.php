...
$_lang['help_main_head'] = 'Are you in need of assistance?';
$_lang['help_main_subhead'] = 'Our goal is to present you with a website in which you can find your way. However, websites are complex creations, so it could be possible that you end up in a situation which might require some assistance. As the servicedesk of Sterc, we are here to help you in those situations!';
$_lang['supportoptions_head'] = 'Contact the Sterc servicedesk';
$_lang['help_supportoption_1_head'] = ' Give us a call';
$_lang['help_supportoption_1_description'] = 'Are you in a website emergency? Contact us at <a href="tel:+31 512 36 11 14" target="_blank">+31 512 36 11 14</a>.';
$_lang['help_supportoption_2_head'] = ' Create a ticket';
$_lang['help_supportoption_2_description'] = ' Are you having a complex problem which demands a proper description to understand? Please <a href="https://sterc.zendesk.com/hc/nl/requests/new" target="_blank">create a ticket</a>.';
...
$_lang['email_sub'] = 'Receive Sterc\'s MODX newsletter';
